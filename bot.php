			...
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/SYY767/5",
                   'caption'=>'تم البرمجة بواسطة (@d_y_c) ' ,
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'ها تريد تسجل وهمي ؟🦦','callback_data'=>'login']],
                          [['text'=>"المطور",'url'=>"https://t.me/d_y_c"]],
                      ]
                  ])
              ]);   
          } 
if($text == '/J'){
              ...
              'caption'=>'هاك اتونس',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"اشترك بهاي القناة وياك ", 'url'=>"https://t.me/YYQQO"]],
                       ]
                       ])
                       ]);
          	...
          	if($config['mode'] != null){
          		...
          		if($mode == 'addL'){
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                      'text'=>"حجي هاي صفحة التحكم مالتك اي شي تريدة راسل SAJAD - @d_y_c",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'تشغيل البوت ▶️','callback_data'=>'run'],['text'=>'ايقاف البوت ⏸','callback_data'=>'stop']],
                              ...
                              [['text'=>' 𝗦𝗔𝗝𝗔𝗗','url'=>'t.me/d_y_c'],['text'=>' 𝗖𝗛 ','url'=>'t.me/YYQQO']],
                      ]
                  ])
                  ]);
          		    $config['mode'] = null;
					...
					$bot->sendMessage([
							...
							'reply_markup'=>json_encode([
                  'inline_keyboard'=>[
                      [['text'=>'SAJAD 🕸','url'=>'t.me/d_y_c']]
					  [['text'=>"▪️| قناة صيد المشتركين", 'url'=>"t.me/YYQQO"]],
                  ]
							])
					]);
				}
...
'𝐹𝑂𝐿𝐿𝑂𝑊𝐸𝑅𝑆','callback_data'=>'followers'],['text'=>"𝐹𝑂𝐿𝐿𝑂𝑊𝐼𝑁𝐺",'callback_data'=>'following']],
              ...
              $bot->sendMessage([
                'chat_id'=>$chatId,
                'text'=>"*بدء الفحص برعايه عمك ⊰SAJAD ~ @d_y_c⊱*\n Account: `".explode(':',$data[1])[0].'`',
                'parse_mode'=>'markdown'
              ]);
          	} elseif($data[0] == 'stop'){
          	  $bot->editMessageText([
